...
export default function Quiz() {
	...
	return (
		<>
			<div className='app1' style={{ width: "450px" }}>
			...
			{showScore ? (
				<>
					...
					<div className='app1' style={{ width: "450px", height: "60px" }}>
						<div className='question-section'>
							<div style={{ textAlign: 'center' }} className='question-text'>Want to veiw answers? <Link to='/showanswers' style={{ marginLeft: "20px", textAlign: 'center', textDecoration: "none" }}><button style={{ width: "250px", marginLeft: "95px" }}>Veiw Answers</button></Link></div>
						</div>
					</div>
				</>
